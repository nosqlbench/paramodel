...
/// Element connectionPool = ...; // "db-pool"
...
public enum RelationshipType {
    ...
    ///
    /// ```
    /// For all trials t1, t2 using element E:
    ///   execution(t1, E) and execution(t2, E) do not overlap
    ///
    ...
    ///
    /// ```
    /// For all trials t1, t2, ..., tn using element E:
    ...
    ///
    /// ```java
    /// Element cache = ...;   // "embedding-cache"
    /// Element encoder = ...; // "text-encoder"
    ///
    ...
    ///
    /// ```java
    /// Element container = ...; // "test-environment"
    ///
