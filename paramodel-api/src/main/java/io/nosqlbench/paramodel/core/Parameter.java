...
/// ## Type Categories
///
/// Parameters come in three fundamental categories:
///
/// ```
/// Parameter<T>
/// ├── DiscreteParameter<T>      - Finite or countably infinite values
/// │   └── Examples: enums, integer ranges, string literals
/// ├── ContinuousParameter<T>    - Real-valued with bounds
/// │   └── Examples: floating-point ranges, durations
/// └── CompositeParameter<T>     - Structured combinations
///     └── Examples: records, tuples, nested objects
/// ```
///
...
public interface Parameter<T> {
    ...
    ///
    /// Returns metadata about this parameter including generation strategy,
    /// creation time, and other descriptive information.
    ///
    ...
    ///
    /// @return parameter metadata, never null
